...
test('should inline a file as a string', async t => {
  await t.context.bundle(__dirname + '/integration/fs/index.js');
  const output = t.context.run();
  t.is(output, 'hello');
});

test('should inline a file as a buffer', async t => {
...
test('should inline a file with fs require alias', async t => {
  await t.context.bundle(__dirname + '/integration/fs-alias/index.js');
  const output = t.context.run();
  t.is(output, 'hello');
});

test('should inline a file with fs require inline', async t => {
  await t.context.bundle(__dirname + '/integration/fs-inline/index.js');
  const output = t.context.run();
  t.is(output, 'hello');
});

test('should inline a file with fs require assignment', async t => {
  await t.context.bundle(__dirname + '/integration/fs-assign/index.js');
  const output = t.context.run();
  t.is(output, 'hello');
});

test('should inline a file with fs require assignment alias', async t => {
  await t.context.bundle(__dirname + '/integration/fs-assign-alias/index.js');
  const output = t.context.run();
  t.is(output, 'hello');
});

test('should inline a file with fs require destructure', async t => {
  await t.context.bundle(__dirname + '/integration/fs-destructure/index.js');
  const output = t.context.run();
  t.is(output, 'hello');
});

test('should inline a file with fs require destructure assignment', async t => {
